...
/*
 * AllocTcharToChar - メモリを確保して TCHAR を char に変換する
 */
#ifdef UNICODE
...
/*
 * AllocCharToTchar - メモリを確保して char を TCHAR に変換する
 */
#ifdef UNICODE
...
/*
 * TStrJoin - 文字列を連結して最後の文字のアドレスを返す
 */
...
/*
 * TStrCmpI - 文字列の大文字小文字を区別しない比較を行う (TCHAR)
 */
...
/*
 * TStrCmpNI - 文字列の大文字小文字を区別しない比較を行う (TCHAR)
 */
...
/*
 * StrCmpNI - 文字列の大文字小文字を区別しない比較を行う
 */
#ifdef UNICODE
