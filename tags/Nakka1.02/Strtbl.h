...
#define STR_ERR_SOCK_STAT			TEXT("STAT が受け付けられませんでした\n\n")
#define STR_ERR_SOCK_RETR			TEXT("RETR が受け付けられませんでした\n\n")
...
#define STR_MSG_NOBODY				TEXT("本文が取得されていないため開くことができません\n\n")\
									TEXT("'受信用にﾏｰｸ'を付けて'ﾏｰｸしたものを実行'を行って本文を取得してください")
...
#define STR_CMDBAR_EXEC				TEXT("ﾏｰｸしたものを実行")
