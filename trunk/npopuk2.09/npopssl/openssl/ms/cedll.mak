...
PLATFORM=VC-CE
CC=$(CC)
CFLAG= /MC /O1i /W3 /WX /GF /Gy /nologo -DUNICODE -D_UNICODE -DOPENSSL_SYSNAME_WINCE -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -DNO_CHMOD -I"C:\My Documents\VisualStudio\wcecompat-1.2\include" -I"C:\Windows CE Tools\WCE211\MS HPC Pro\include" -DOPENSSL_SMALL_FOOTPRINT -D_WIN32_WCE=211 -DUNDER_CE=211 -DWCE_PLATFORM_"MS_HPC_PRO" -DARM -D_ARM_ -DARM /Fdout32dll_$(TARGETCPU) -DOPENSSL_NO_IDEA -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_KRB5 -DOPENSSL_NO_EC -DOPENSSL_NO_ECDSA -DOPENSSL_NO_ECDH -DOPENSSL_NO_DYNAMIC_ENGINE    
APP_CFLAG=
...
LINK=link
LFLAGS=/nologo /opt:ref /subsystem:windowsce,2.11 /machine:ARM
RSC=rc
...
MKLIB=lib
MLFLAGS= /nologo /opt:ref /subsystem:windowsce,2.11 /machine:ARM /dll
ASM=ml /Cp /coff /c /Cx
...
HEADER=$(INCL_D)\e_os.h \
	...
	$(INCL_D)\bio_lcl.h $(INCL_D)\obj_dat.h $(INCL_D)\pcy_int.h \
	$(INCL_D)\conf_def.h $(INCL_D)\ui_locl.h $(INCL_D)\str_locl.h \
...
EXHEADER=$(INCO_D)\e_os2.h \
	...
	$(INCO_D)\rc2.h $(INCO_D)\rc4.h $(INCO_D)\blowfish.h \
	$(INCO_D)\cast.h $(INCO_D)\aes.h $(INCO_D)\bn.h \
	$(INCO_D)\rsa.h $(INCO_D)\dsa.h $(INCO_D)\dso.h \
	$(INCO_D)\dh.h $(INCO_D)\buffer.h $(INCO_D)\bio.h \
	...
	$(INCO_D)\store.h $(INCO_D)\pqueue.h $(INCO_D)\pq_compat.h \
