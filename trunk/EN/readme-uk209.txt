nPOPuk v2.09(rc1)                          readme-209uk.txt
                                                11 Nov 2007
-----------------------------------------------------------
...
http://www.npopsupport.org.uk/downloads.htm.
...
*  If you need help configuring nPOP see:
   http://www.npopsupport.org.uk/install.htm 
...
* Filter improvements: whitelisting the address book
  or checking relative dates (N days ago)

* Ability to salvage mail data already received if
  the connection is lost (wifi, dialup, or otherwise)
...
* Improvements to the address book, including sort by
  column.
