...
#define STR_LIST_MENU_DELMARK		TEXT("&Mark for delete\tDel")
#define STR_LIST_MENU_DELMARK_OLD	TEXT("&Mark for delete\tCtrl+Ddel")
...
#define STR_LIST_MENU_DELLIST		TEXT("Delete from &list\tCtrl+Del")
#define STR_LIST_MENU_DELLIST_OLD	TEXT("Delete from &list\tDel")
...
#define STR_LIST_PPCMENU_DELMARK	TEXT("&Mark for delete")
