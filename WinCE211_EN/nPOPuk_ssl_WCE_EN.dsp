...
!MESSAGE 
!MESSAGE NMAKE /f "nPOPuk_ssl_WCE_EN.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "nPOPuk_ssl_WCE_EN.mak" CFG="nPOPuk_WCE_EN - Win32 (WCE ARM) Debug"
!MESSAGE 
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_MIPS\libeay32.lib ..\openssl\out32_MIPS\ssleay32.lib ..\zlib_wce\lib_mips\zlib_wce.lib ..\wcecompat\lib_mips\wcecompat.lib /nologo /machine:MIPS /nodefaultlib:"$(CENoDefaultLib)" /out:"MIPSRel/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_MIPS\libeay32.lib ..\openssl\out32_MIPS\ssleay32.lib ..\zlib_wce\lib_mips\zlib_wce.lib ..\wcecompat\lib_mips\wcecompat.lib /nologo /debug /machine:MIPS /nodefaultlib:"$(CENoDefaultLib)" /out:"MIPSDbg/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_SH4\libeay32.lib ..\openssl\out32_SH4\ssleay32.lib ..\zlib_wce\lib_sh4\zlib_wce.lib ..\wcecompat\lib_sh4\wcecompat.lib /nologo /machine:SH4 /nodefaultlib:"$(CENoDefaultLib)" /out:"SH4Rel/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_SH4\libeay32.lib ..\openssl\out32_SH4\ssleay32.lib ..\zlib_wce\lib_sh4\zlib_wce.lib ..\wcecompat\lib_sh4\wcecompat.lib /nologo /debug /machine:SH4 /nodefaultlib:"$(CENoDefaultLib)" /out:"SH4Dbg/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_SH3\libeay32.lib ..\openssl\out32_SH3\ssleay32.lib ..\zlib_wce\lib_sh3\zlib_wce.lib ..\wcecompat\lib_sh3\wcecompat.lib /nologo /machine:SH3 /nodefaultlib:"$(CENoDefaultLib)" /out:"SH3Rel/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_SH3\libeay32.lib ..\openssl\out32_SH3\ssleay32.lib ..\zlib_wce\lib_sh3\zlib_wce.lib ..\wcecompat\lib_sh3\wcecompat.lib /nologo /debug /machine:SH3 /nodefaultlib:"$(CENoDefaultLib)" /out:"SH3Dbg/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_ARM\libeay32.lib ..\openssl\out32_ARM\ssleay32.lib ..\zlib_wce\lib_arm\zlib_wce.lib ..\wcecompat\lib_arm\wcecompat.lib /nologo /machine:ARM /nodefaultlib:"$(CENoDefaultLib)" /out:"ARMRel/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 commctrl.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32_ARM\libeay32.lib ..\openssl\out32_ARM\ssleay32.lib ..\zlib_wce\lib_arm\zlib_wce.lib ..\wcecompat\lib_arm\wcecompat.lib /nologo /debug /machine:ARM /nodefaultlib:"$(CENoDefaultLib)" /out:"ARMDbg/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 $(CEx86Corelibc) $(CEx86Corelibc) commctrl.lib coredll.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32\libeay32.lib ..\openssl\out32\ssleay32.lib /nologo /machine:IX86 /nodefaultlib:"OLDNAMES.lib" /nodefaultlib:"$(CENoDefaultLib)" /out:"X86Rel/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
# ADD LINK32 $(CEx86Corelibc) $(CEx86Corelibc) commctrl.lib coredll.lib winsock.lib ole32.lib oleaut32.lib ..\openssl\out32\libeay32.lib ..\openssl\out32\ssleay32.lib /nologo /debug /machine:IX86 /nodefaultlib:"OLDNAMES.lib" /nodefaultlib:"$(CENoDefaultLib)" /out:"X86Dbg/nPOPuk.exe" /stack:0x10000,0x1000 /subsystem:$(CESubsystem)
...
DEP_CPP_WINSO=\
	"..\EN\Strtbl.h"\
	"..\openssl\inc32\openssl\asn1.h"\
	"..\openssl\inc32\openssl\bio.h"\
	"..\openssl\inc32\openssl\bn.h"\
	"..\openssl\inc32\openssl\buffer.h"\
	"..\openssl\inc32\openssl\comp.h"\
	"..\openssl\inc32\openssl\crypto.h"\
	"..\openssl\inc32\openssl\dh.h"\
	"..\openssl\inc32\openssl\dsa.h"\
	"..\openssl\inc32\openssl\dtls1.h"\
	"..\openssl\inc32\openssl\e_os2.h"\
	"..\openssl\inc32\openssl\ebcdic.h"\
	"..\openssl\inc32\openssl\evp.h"\
	"..\openssl\inc32\openssl\hmac.h"\
	"..\openssl\inc32\openssl\kssl.h"\
	"..\openssl\inc32\openssl\lhash.h"\
	"..\openssl\inc32\openssl\obj_mac.h"\
	"..\openssl\inc32\openssl\objects.h"\
	"..\openssl\inc32\openssl\opensslconf.h"\
	"..\openssl\inc32\openssl\opensslv.h"\
	"..\openssl\inc32\openssl\ossl_typ.h"\
	"..\openssl\inc32\openssl\pem.h"\
	"..\openssl\inc32\openssl\pem2.h"\
	"..\openssl\inc32\openssl\pkcs7.h"\
	"..\openssl\inc32\openssl\pq_compat.h"\
	"..\openssl\inc32\openssl\pqueue.h"\
	"..\openssl\inc32\openssl\rsa.h"\
	"..\openssl\inc32\openssl\safestack.h"\
	"..\openssl\inc32\openssl\sha.h"\
	"..\openssl\inc32\openssl\ssl.h"\
	"..\openssl\inc32\openssl\ssl2.h"\
	"..\openssl\inc32\openssl\ssl23.h"\
	"..\openssl\inc32\openssl\ssl3.h"\
	"..\openssl\inc32\openssl\stack.h"\
	"..\openssl\inc32\openssl\symhacks.h"\
	"..\openssl\inc32\openssl\tls1.h"\
	"..\openssl\inc32\openssl\x509.h"\
	"..\openssl\inc32\openssl\x509_vfy.h"\
	"..\src\Font.h"\
	"..\src\General.h"\
	"..\src\npop_ver.h"\
	"..\src\openssl.h"\
